...
from scripts.policy_objects.create_policy_objects import create_policy_objects
import threading

class CreatePolicyObjectsWindow(tk.Toplevel):
    def __init__(self, master=None):
        super().__init__(master)
        self.title("Create Policy Objects")
    ...
    def create_widgets(self):
            # Title label
            ttk.Label(self, text="Create Policy Objects from CSV", font=("Segoe UI", 14)).pack(pady=10)
    ...
    def run_creation(self):
        try:
            ...
            result = create_policy_objects(csv_file=selected_file, log_callback=self.log_to_gui, debug=True)
