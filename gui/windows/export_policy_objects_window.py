...
from scripts.policy_objects.export_policy_objects import export_policy_objects
import threading

class ExportPolicyObjectsWindow(tk.Toplevel):
    def __init__(self, master=None):
        super().__init__(master)
        self.title("Export Policy Objects")
    ...
    def create_widgets(self):
            # Title label
            ttk.Label(self, text="Export Policy Objects to CSV", font=("Segoe UI", 14)).pack(pady=10)
    ...
    def run_export(self):
        try:
            ...
            result = export_policy_objects(csv_file=selected_file, log_callback=self.log_to_gui, debug=True)
